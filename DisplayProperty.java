 ...
 * @author Abi
 */
public class DisplayProperty extends javax.swing.JFrame {

    /**
     * Creates new form DisplayProperty
     */
    ...
    private void btnExitDeliveryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExitDeliveryActionPerformed
        ...
        int answer = JOptionPane.showConfirmDialog(this, "Exit Property?", "Confirm!", JOptionPane.YES_NO_OPTION);
    ...
    private void btnRetrieveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRetrieveActionPerformed
        ...
        PropertyDB pb = new PropertyDB();

        DefaultTableModel dm = pb.getData();
        jTable1.setModel(dm);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DisplayProperty.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DisplayProperty().setVisible(true);
            }
        });
    }
